...
import type { DocumentMethods, EditorContent, EditorContentRecord, RpcReturnProxy } from '../../shared';

export function createContentFacade(methods: RemoteProxy<DocumentMethods>): RpcReturnProxy<EditorContent> {
